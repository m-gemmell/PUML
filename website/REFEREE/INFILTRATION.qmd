...
If the player team decides to infiltrate a location by stealth, subterfuge, or some other means you can use a tracker measure the alertness of the base and its occupants.
...
Whilst suspicious guards/occupants will be more discerning. They will:
...
- Their will be more frequent patrols with higher numbers of guards
- They will have any and all security systems in place
...
- Shooting first and ask questions later
- Calling in reinforcements
- All lock down and security systems to be activate
...
The difficulty of the infiltration determines the amount of spaces on the __alert trackers__.
...
- Difficulty can be decreased by sufficient preplanning.
  ...
  - Have the team orchestrated a distratcion at a different location occurring at the same time?
...
3.  **Referee fiat:** If, as the referee, you feel a player action or its consequence should mark of a space or even move straight to the **alert level** then by all means do.
